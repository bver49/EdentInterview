...
exports.signup = function signup(email){
  ...
  <body style='color:black;'>\
    ...
    為了完成註冊，請您於「3天內」依序完成幾件事：</p>\
    <p style='color:black;'>個人報名</p>\
    <p style='color:black;'>1.匯款：將 3600元轉入本團隊帳戶，您可以使用您在地的ATM進行轉帳、或洽詢銀行郵局協助辦理，並請保留交易明細表。</p>\
    <p style='color:black;'>2.輸入轉帳帳號末五碼：登入醫甸面試官網， 輸入剛剛用來轉帳的帳號末五碼（轉出帳號末五碼）， 輸入後，我們將以人工進行審核，盡快為您開通帳號、完成註冊。</p>\
    <br>\
    <p style='color:black;'>三人團報方案</p>\
    <p style='color:black;'>1.請欲團報的三人都註冊本站會員</p>\
    <p style='color:black;'>2.由 “一個人” 負責將 10200元 直接轉入本團隊帳戶，您可以使用您在地的ATM進行轉帳、或洽詢銀行郵局協助辦理，並請保留交易明細表</p>\
    <p style='color:black;'>3.三人於同一天內登入本站，三人皆輸入該轉帳帳號末五碼，我們將以人工進行審核，盡快為您開通帳號、完成註冊。（若有問題請洽下方團隊信箱）</p>\
    <br>\
    <p style='color:black;'>**本公司帳戶資訊**</p>\
